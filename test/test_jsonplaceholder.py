...
def test_creating_and_check_post():
    payload = {"title": "test_Solovev", "body": "MTT", "userId": 77}
    ...
    assert response.json()["title"] == "test_Solovev"
...
def test_patch_and_delete_post(patch_post):
    ...
    assert patch_post.json()["title"] == "test_Solovev_patch"
...
def test_update_and_check_post():
    payload = {"title": "test_Solovev", "body": "update", "userId": 999, "id": 500}
    headers = {'Content-type': 'application/json; charset=UTF-8'}
